...
export PROCESS_MONITOR_REDIS_URL="${PROCESS_MONITOR_REDIS_URL:-redis://localhost:5120/1}"
export REMOTE_MONITORING_ENABLED="${REMOTE_MONITORING_ENABLED:-false}"
export WEBSOCKET_TOKEN_SECRET="${WEBSOCKET_TOKEN_SECRET:-change_me_in_production}"
export WEBSOCKET_API_KEYS="${WEBSOCKET_API_KEYS:-qlib_4XmvxxucwqHLST9olQcEgZoZXsPoYLt5qr1cPIFWljY}"

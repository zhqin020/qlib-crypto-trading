...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--symbols",
        default="BTC/USDT,ETH/USDT,BNB/USDT,SOL/USDT,XRP/USDT,ADA/USDT,DOGE/USDT,AVAX/USDT,DOT/USDT,MATIC/USDT",
        help="Comma-separated list of symbols to download",
    )
    parser.add_argument("--start", dest="start_date", default=default_start, help="Inclusive start date (YYYY-MM-DD)")
    parser.add_argument("--end", dest="end_date", default=default_end, help="Inclusive end date (YYYY-MM-DD)")
